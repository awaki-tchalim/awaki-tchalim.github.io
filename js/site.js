				...
				if (rsFormCaptcha === true) {
					...
					$.post( rsFormAction,
						...
						function (response) {
							...
							if(data){								
								rsForm.append('<div class="rsFormResponce"><strong>Merci!</strong><br>Votre message a bien été envoyé, je vous ferai un retour dans un bref délai !</div>');
							} else {
								rsForm.append('<div class="rsFormResponce"><strong>OOPS!</strong> Oops erreur !<br>prière de réessayer.</div>');
							}							
						}
					);
					return false;
